 ...
 */
public class TTAgreementDataEncoder implements ProtocolEncoder {
	static Logger logger = Logger.getLogger(TTAgreementDataEncoder.class.getName());
